...
public class Square {
    ...
    public float[] barvaKolize;
    public float[] normalniBarva;
    ...
    public Square(float x, float y, float z) {
        ...
        normalniBarva = new float[]{
                1f, 0f, 0f, 1f,
                1f, 0f, 0f, 1f,
                1f, 0f, 0f, 1f,
                1f, 0f, 0f, 1f,
        };
        barvaKolize = new float[]{
                0f, 1f, 0f, 1f,
                0f, 1f, 0f, 1f,
                0f, 1f, 0f, 1f,
                0f, 1f, 0f, 1f,
        ...
        cfb = BufferUtils.createFloatBuffer(barvaKolize.length).put(barvaKolize).flip();
